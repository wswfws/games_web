  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-100 p-8 max-w-3xl mx-auto">
      ...
      <section className="mb-8">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-slate-800/50 rounded-lg p-4">
            <div className="flex items-center gap-2 mb-1">
              <span className="text-2xl">🏠</span>
              <span className="font-bold">Дом</span>
            </div>
            <p className="text-slate-400 text-sm">
              Увеличивает лимит популяции на +2. Без дома макс. 4 котика.
              С каждым домом можно завести больше котиков — а значит, больше пирсов и рыбы.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-slate-300 leading-relaxed">
          Если кормить котиков без перебоев — каждые 5 успешных кормлений рождается <strong>+1 котёнок</strong>.
          Популяция не может превысить лимит (<strong>maxCats</strong>). Домики увеличивают лимит.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="space-y-2 text-slate-300">
          ...
          <li><kbd className="bg-slate-700 px-1 rounded">1</kbd> — пирс, <kbd className="bg-slate-700 px-1 rounded">2</kbd> — тропинка, <kbd className="bg-slate-700 px-1 rounded">3</kbd> — дом</li>
        </ul>
      </section>
