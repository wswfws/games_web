        ...
        {buildings.map((building, index) => {
          ...
          return (
            <button
              ...
              className={`relative w-12 h-12 flex flex-col items-center justify-center rounded-full text-xl transition-all ${
                isSelected
            ...
            >
              ...
              {BUILDING_DEFS[building].catWorkers > 0 && (
                <span className="text-[8px] leading-none text-yellow-300">🐱{BUILDING_DEFS[building].catWorkers}</span>
              )}
